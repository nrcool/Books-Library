...
import { faLock, faAt, faLockOpen } from '@fortawesome/free-solid-svg-icons'
    ...
    render() {
        return (
            ...
            <form className="form-inputs" name="signInForm" onSubmit={this.signupSubmit}>
              ...
              <div className="form-group">
                <label className="input-label" htmlFor="crtePassword"><FontAwesomeIcon icon={faLockOpen} /> Create Password*</label>
                <input type="password" className="form-control" name="password" id="crtePassword"
                  placeholder="password" />
              </div>
              <div className="form-group">
                <label className="input-label" htmlFor="confirmPassword"><FontAwesomeIcon icon={faLock} /> Confirm
                        Password*</label>
